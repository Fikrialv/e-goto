<x-layouts.auth title="Masuk" description="Masuk ke akun E-GOTO untuk memesan trip dan melihat e-tiket Anda.">
    <x-auth-split title="Masuk" subtitle="Lanjutkan pemesanan trip Anda.">
        @if (session('status'))
            <p class="mb-6 rounded-2xl bg-teal-50 px-4 py-3 text-sm text-teal-700">{{ session('status') }}</p>
        @endif
