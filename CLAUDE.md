...
Empat aturan warna & aset yang ditetapkan 2026-08-28 dan berlaku permanen:
...
- **Berkas logo dipilih sesuai konteks, jangan satu untuk semua.** `Logo1.svg` wordmark horizontal — header form masuk, footer, `brandLogo` Filament. `logo2.svg` bentuk saja tanpa teks — loading screen, overlay submit, favicon. Tidak ada berkas ketiga; jangan mengarang turunan tanpa diminta.
